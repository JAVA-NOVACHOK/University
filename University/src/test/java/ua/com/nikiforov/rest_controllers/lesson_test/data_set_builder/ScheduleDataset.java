...
public class ScheduleDataset extends SetupTestHelper implements DataSetProvider {
    ...
    public IDataSet provide() throws DataSetException {
        return new DataSetBuilder()
                ...
                .values(2,2,2,1,DATE,1)
                .values(3,1,3,1,DATE,1)
                .values(1,1,1,1,DATE_1,1)
                .values(2,2,2,1,DATE_1_ADD_3_DAYS,1)
                .values(1,3,3,1,DATE_1_ADD_13_DAYS,1)
                .values(1,3,3,1,DATE_1_ADD_33_DAYS,1)
                .build();
    }
}
