...
class StudentTimetableServiceTest {
    ...
    void setup() {
        ...
        lessonService.addLesson(PERIOD_1, subject_1.getId(), room_1.getId(), group_1.getGroupId(), DATE,
                teacher_1.getId());
        lessonService.addLesson(PERIOD_2, subject_2.getId(), room_2.getId(), group_1.getGroupId(), DATE,
                teacher_2.getId());
        lessonService.addLesson(PERIOD_3, subject_3.getId(), room_3.getId(), group_1.getGroupId(), DATE,
                teacher_3.getId());
        ...
        lessonService.addLesson(PERIOD_1, subject_3.getId(), room_2.getId(), group_1.getGroupId(), DATE_1_ADD_1_DAY,
                teacher_1.getId());
        lessonService.addLesson(PERIOD_2, subject_2.getId(), room_2.getId(), group_1.getGroupId(), DATE_1_ADD_1_DAY,
                teacher_2.getId());
        lessonService.addLesson(PERIOD_3, subject_3.getId(), room_3.getId(), group_1.getGroupId(), DATE_1_ADD_1_DAY,
                teacher_3.getId());
        ...
        lessonService.addLesson(PERIOD_1, subject_3.getId(), room_3.getId(), group_1.getGroupId(), DATE_1_ADD_13_DAYS,
                teacher_3.getId());
