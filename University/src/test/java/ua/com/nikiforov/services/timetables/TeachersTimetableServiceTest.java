...
class TeachersTimetableServiceTest {
    ...
    void whenGetDayTimetableByDateAndTeacherIdShouldReturnListOfTimetables() {
        ...
        expectedTimetables.add(new TimetableDTO(lesson_2_date.getId(), PERIOD_2, SUBJECT_NAME_2, TEST_ROOM_NUMBER_2,
                ...
                getLocalDateFromString(DATE)));
        expectedTimetables.add(new TimetableDTO(lesson_3_date.getId(), PERIOD_3, SUBJECT_NAME_1, TEST_ROOM_NUMBER_2,
    ...
    void whenGetMonthTimetableByDateAndTeacherIdShouldReturnListOfDayTimetables() {
        ...
        expectedTimetables_DATE.add(new TimetableDTO(lesson_2_date.getId(), PERIOD_2, SUBJECT_NAME_2, TEST_ROOM_NUMBER_2,
                TEST_GROUP_NAME_2, TEACHERS_FIRST_NAME_1 + " " + TEACHERS_LAST_NAME_1, teacher_1.getId(),
                getLocalDateFromString(DATE)));
        expectedTimetables_DATE.add(new TimetableDTO(lesson_3_date.getId(), PERIOD_3, SUBJECT_NAME_1, TEST_ROOM_NUMBER_2,
                TEST_GROUP_NAME_3, TEACHERS_FIRST_NAME_1 + " " + TEACHERS_LAST_NAME_1, teacher_1.getId(),
                getLocalDateFromString(DATE)));
        ...
        expectedTimetables_DATE_ADD_1_DAY.add(new TimetableDTO(lesson_2_date_day_1.getId(), PERIOD_3, SUBJECT_NAME_3,
        ...
        expectedTimetables_DATE_ADD_13_DAYS.add(new TimetableDTO(lesson_1_date_day_13.getId(), PERIOD_1, SUBJECT_NAME_1,
        ...
        expectedTimetables_DATE_ADD_13_DAYS.add(new TimetableDTO(lesson_2_date_day_13.getId(), PERIOD_2, SUBJECT_NAME_2,
        ...
        expectedTimetables_DATE_ADD_21_DAYS.add(new TimetableDTO(lesson_1_date_day_21.getId(), PERIOD_2, SUBJECT_NAME_2,
                TEST_ROOM_NUMBER_2, TEST_GROUP_NAME_1, TEACHERS_FIRST_NAME_1 + " " + TEACHERS_LAST_NAME_1,
